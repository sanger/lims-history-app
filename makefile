...
CORE_PATH = '.'
migrate_test_mysql:
	mysql -uroot -p -e "DROP DATABASE IF EXISTS warehouse_test; CREATE DATABASE warehouse_test DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;"
	bundle exec sequel -m $(CORE_PATH)/db/migrations -e test_mysql config/database.yml
migrate_dev_mysql:
	mysql -uroot -p -e "DROP DATABASE IF EXISTS warehouse_development; CREATE DATABASE warehouse_development DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;"
